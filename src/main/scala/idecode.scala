...
object TagDecode extends DecodeConstants
{
  val table: Array[(BitPat, List[BitPat])] = Array(
                ...
                //   |     | | | | | | | |       |       |      |      |         | |         |     | | | |     | | | | | amo
                //   |     | | | | | | | |       |       |      |      |         | |         |     | | | |     | | | | | |
    LTAG->      List(xpr64,N,N,N,N,N,N,Y,A2_IMM, A1_RS1, IMM_I, DW_XPR,FN_ADD,   Y,M_XRD,    MT_T, N,N,N,N,N,Y,CSR.N,N,N,N),
    STAG->      List(xpr64,N,N,N,N,N,Y,Y,A2_IMM, A1_RS1, IMM_S, DW_XPR,FN_ADD,   Y,M_XWR,    MT_T, N,N,N,N,N,N,CSR.N,N,N,N))
}